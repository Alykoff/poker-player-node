...
var game_state_simple_no_cards = {
    "tournament_id": "55e4be2d4adaaf0003000002",
    "game_id": "5607a8e4e9958b0003000015",
    "round": 0,
    "players": [{
...
describe('player', function () {
    describe('get_cards', function () {
        it('any cards', function () {
            cards = player.get_player_cards(game_state_simple);
            assert(cards.length > 0);
        });

        it('empty cards', function () {
            cards = player.get_player_cards(game_state_simple_no_cards);
            assert(cards.length == 0);
        });
    });
});
